...
public class MyPanel extends JPanel {
    ...
    private void segment (int number){
       switch (number){
           ...
           case 3: outlist.add(new Rectangle(x+delta, y+height));
           break;

           case 4: outlist.add(new Rectangle(width,y+(height/2)+delta, width, y+height));
           break;

           case 5: outlist.add(new Rectangle(x+delta, y+height, width-delta, y+height ));
           break;

           case 6 : outlist.add(new Rectangle(x, y+(height/2)+delta ));
           break;
